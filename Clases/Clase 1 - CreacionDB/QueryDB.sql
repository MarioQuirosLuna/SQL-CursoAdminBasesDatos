...
(
	...
	,CREDIT_CARD_BRAND_ID INT NOT NULL --1 VISA 2MC 3AMEX 
	...
	,LAST_MODIFIED_BY VARCHAR(50) NULL DEFAULT SUSER_NAME()
	,LAST_MODIFIED_DATE DATETIME NULL DEFAULT GETDATE()
	,CONSTRAINT FK_CREDIT_CARD_BRAND_ID FOREIGN KEY(CREDIT_CARD_BRAND_ID) REFERENCES CUSTOMERS.[tb_CREDIT_CARD_BRANDS](CREDIT_CARD_BRAND_ID) 
)
...
CREATE TABLE FINANCIAL_DEPOSIT.COUNTRY_CURRENCY
(
	CURRENCY_ID INT NOT NULL
	,COUNTRY_ID INT NOT NULL
	,CONSTRAINT FK_CURRENCY_ID FOREIGN KEY (CURRENCY_ID) REFERENCES FINANCIAL_DEPOSIT.tb_CURRENCY(CURRENCY_ID)
	,CONSTRAINT FK_COUNTRY_ID FOREIGN KEY (COUNTRY_ID) REFERENCES CUSTOMERS.tb_COUNTRY(COUNTRY_ID)
)
...
(
	...
	,CONSTRAINT FK_CURRENCY_ID2 FOREIGN KEY (CURRENCY_ID) REFERENCES FINANCIAL_DEPOSIT.tb_CURRENCY (CURRENCY_ID)
